...
echo ""
echo "Next steps:"
echo "  1. Edit AGENTS.md — fill in project details (canonical; CLAUDE.md @imports it; no GEMINI.md)"
...
echo "  4. Install the tlab plugin (agentic workflows):"
echo "     - Claude Code: claude plugin install tlab@tlab-research --scope project"
echo "     - Codex:       add the tlab-research marketplace in ~/.codex/config.toml"
echo "     - Antigravity: no install — it reads AGENTS.md directly"
