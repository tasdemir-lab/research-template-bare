...
mkdir -p _lit/papers _lit/books _lit/policy _lit/slides _lit/notes
mkdir -p _trash
mkdir -p tmp
...
echo "  _lit/     — reference materials (papers, books, policy docs)"
...
echo "     claude plugin marketplace add murattasdemir/tlab-research"
